...
class Morrowind_WiwlandTest extends PageTest {
    ...
    function testInstance() {
        $this->helpTestInstance(new URL('http://morromods.wiwiland.net/spip.php?article181'));
    }
    ...
    function testMod2() {
        ...
        $this->helpTestModPage(
            new URL('http://morromods.wiwiland.net/spip.php?article958'),
            1,
            $mod
        );
    }
    ...
    function testMod3() {
        ...
        $this->helpTestModPage(
            new URL('http://morromods.wiwiland.net/spip.php?article994'),
            1,
            $mod
        );
    }
/*
    function testMod4() {
        ...
        $this->helpTestModPage(
            new URL('http://morromods.wiwiland.net/spip.php?article996'),
            1,
            $mod
        );
    }
 */
    ...
    function testLinks() {
        ...
        $this->helpRequiredLinks(
            new URL("http://morromods.wiwiland.net/spip.php?page=classemois"),
            $links
        );
    }

...
class yacoby_silgrad_comTest extends PageTest {
    ...
    function __construct() {
        parent::__construct(
            'yacoby_silgrad_com',
            new URL('http://yacoby.silgrad.com/MW/Mods/PursuitEnhanced.htm')
        );
    }

    function testInstance() {
        $this->helpTestInstance(new URL('http://yacoby.silgrad.com/MW/Mods/PursuitEnhanced.htm'));
    }
    ...
    function testMod2() {
        ...
        $this->helpTestModPage(
            new URL('http://yacoby.silgrad.com/MW/Mods/SwimmingRealism.htm'),
            1,
            $mod
        );
    }

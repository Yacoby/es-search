...
class Oblivion_WiwlandTest /*extends PageTest*/ {
    ...
    function __construct() {
        parent::__construct(
                'Oblivion_Wiwland',
                new Search_Url('http://oblimods.wiwiland.net/spip.php?article228')
        );
    }


    function testInstance() {
        $this->helpTestInstance(new Search_Url('http://oblimods.wiwiland.net/spip.php?article228'));
    }
    ...
    function testMod2() {
        ...
        $this->helpTestModPage(
            new Search_Url('http://oblimods.wiwiland.net/spip.php?article325'),
            1,
            $mod
        );
    }
    */
    ...
    function testMod3() {
        ...
        $this->helpTestModPage(
                new Search_Url('http://oblimods.wiwiland.net/spip.php?article80'),
                1,
                $mod
        );
    }
    ...
    function testMod4() {
        ...
        $this->helpTestModPage(
                new Search_Url('http://oblimods.wiwiland.net/spip.php?article343'),
                1,
                $mod
        );
    ...
    function testMod5() {
        ...
        $this->helpTestModPage(
                new Search_Url('http://oblimods.wiwiland.net/spip.php?article327'),
                1,
                $mod
        );
    ...
    function testMod7() {
        ...
        $this->helpTestModPage(
                new Search_Url('http://oblimods.wiwiland.net/spip.php?article315'),
                1,
                $mod
        );
    }

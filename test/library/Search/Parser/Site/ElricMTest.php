...
class elricm_com_pagetest extends PageTest {
    ...
    function __construct(){
        parent::__construct(
            'elricm_com',
            new Search_Url('http://www.elricm.com/nuke/html/modules.php?op=modload&name=Downloads&file=index&req=viewdownload&cid=4')
        );
    }

    function testInstance(){
        $this->helpTestInstance(new Search_Url('http://www.elricm.com/nuke/html/modules.php?op=modload&name=Downloads&file=index&req=viewdownload&cid=4'));
    }

...
class planetelderscrolls_comTest extends PageTest {
    ...
    public function testLinkStrip() {
        ...
        $page = $factory->getSiteByURL($url)->getPage($url, $this->_client);
    ...
    function __construct() {
        parent::__construct(
            ...
            new Search_Url('http://planetelderscrolls.gamespy.com/View.php?view=Mods.Detail&id=4481')
        );
    }
    ...
    function testMod2() {
        ...
        $this->helpTestModPage(
            new Search_Url('http://planetelderscrolls.gamespy.com/View.php?view=OblivionUtilities.Detail&id=44'),
            1,
            $mod
        );
    }
    ...
    function testMod3() {
        ...
        $this->helpTestModPage(
            new Search_Url('http://planetelderscrolls.gamespy.com/View.php?view=OblivionMods.Detail&id=5770'),
            1,
            $mod
        );
    }
    ...
    function testMod4() {
        ...
        $this->helpTestModPage(
            new Search_Url('http://planetelderscrolls.gamespy.com/View.php?view=OblivionMods.Detail&id=1446'),
            1,
            $mod
        );
    }
    ...
    function testMod5() {
        ...
        $this->helpTestModPage(
            new Search_Url('http://planetelderscrolls.gamespy.com/View.php?view=OblivionMods.Detail&id=5792'),
            1,
            $mod
        );
    }
